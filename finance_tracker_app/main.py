...
class CSV:
    CSV_FILE = "finance_tracker_app/finance_data.csv"
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            print("No transactions found un the given date range")
        else:
...
# CSV.initialize_csv()
# CSV.add_entry("2-11-2024", 24.59, "Income", "description")
...
def main():
    while True:
        ...
        if choise == "1":
            ...
            print("invalid chois, enter 1,2 or 3")
